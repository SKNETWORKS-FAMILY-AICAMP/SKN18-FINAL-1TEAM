...
TRAIN_PATH = "apps/reco/models/trust_model/data/X_train.csv"
TEST_PATH = "apps/reco/models/trust_model/data/X_test.csv"
TRAIN_TARGET_PATH = "apps/reco/models/trust_model/data/y_train.csv"
TEST_TARGET_PATH = "apps/reco/models/trust_model/data/y_test.csv"
